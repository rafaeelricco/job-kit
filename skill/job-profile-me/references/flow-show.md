...
| Path                                                    | Supplies                                                                                                                                   |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| `data/job_search.yaml`                                  | work_model, seniority_level, job_types, date_posted, positions, `keywords.*`, locations, location_scope, direct_regions, market_currencies |
...
- Constraints: work model · seniority level · job types · positions · keywords · locations ·
  date_posted · location_scope · direct_regions · market_currencies · salary_range_usd ·
