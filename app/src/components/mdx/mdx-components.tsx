...
const mdxComponents = {
  h1: (props: ComponentProps<"h1">) => (
    <h1 className="text-2xl font-bold tracking-tight md:text-4xl" {...props} />
  ),
  ...
  h3: (props: ComponentProps<"h3">) => (
    <h3 className="text-lg font-semibold md:text-xl" {...props} />
  ),
  h4: (props: ComponentProps<"h4">) => (
    <h4 className="text-base font-semibold md:text-lg" {...props} />
  ),
  ...
  ul: (props: ComponentProps<"ul">) => (
    <ul className="list-disc pl-5 text-base" {...props} />
  ),
