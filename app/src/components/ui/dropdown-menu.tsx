      ...
      >
        ...
        >
          <ScrollArea
            ...
            viewportProps={{ tabIndex: -1, className: "h-auto max-h-[inherit]" }}
            contentProps={{ className: "p-1" }}
          >
            {children}
          </ScrollArea>
        </MenuPrimitive.Popup>
