...
import { ANONYMOUS, getSession, reloadSession, subscribeToSessionUpdates, type SessionInfo } from "@module/session/session"
...
function SessionRoot() {
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribeToSessionUpdates((m) => setSession({ current: m.withDefault(ANONYMOUS), next: NotAsked() }))
